...
public interface IContratoAluguelRepository : IRepository<ContratoAluguel>, IDisposable
{
    ...
    Task<IEnumerable<SpAreaPriceResult>> GetDashbaordAreaPrice(DateTime dateRefInit, DateTime dateRefEnd, int? idLocador);
    ...
    Task<object> GetDashboardTotalManagedArea(int? idLocador);
    ...
    Task<IEnumerable<SpSupplyContractsResult>?> GetReportSupplyContract(int? idImovel, int? idLocador, int? idLocatario);
